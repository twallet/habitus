import { TrackingScheduleData, MAX_SCHEDULES_PER_TRACKING } from "../types.js";

/**
 * Tracking schedule model class for representing schedule entities.
...
export class TrackingSchedule {
   ...
   * @public
   */
  static readonly MAX_SCHEDULES_PER_TRACKING: number =
