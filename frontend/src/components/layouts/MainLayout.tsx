...
export function MainLayout() {
    const { isAuthenticated, isLoading, user, logout, updateProfile, updateNotificationPreferences, deleteUser, requestEmailChange, getTelegramStartLink, getTelegramStatus, cancelTelegramConnection, disconnectTelegram } = useAuth();
